...
describe('formatKSh', function() {
  test('formats numbers with Kenyan Shilling prefix and commas', function() {
...
describe('daysBetween', function() {
  test('calculates positive difference in days', function() {
    expect(daysBetween('2026-06-20', '2026-06-25')).toBe(5);
    expect(daysBetween('2026-06-01', '2026-06-30')).toBe(29);
  });

  test('returns 0 when end date is before or same as start', function() {
...
describe('validateEmail', function() {
  test('returns true for valid email addresses', function() {
...
describe('validatePhone', function() {
  test('returns true for valid Kenyan numbers', function() {
  ...
  test('returns false for invalid phone numbers', function() {
